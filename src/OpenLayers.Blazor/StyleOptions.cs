...
namespace OpenLayers.Blazor
{
    public class StyleOptions
    {
        ...
        public class TextOptions
        {
            ...
            public List<double> Padding { get; set; } = new List<double> { 0, 0, 0, 0 };
        }
        ...
        {
            public List<double> Anchor { get; set; } = new List<double> { 0.5, 0.5 };
            ...
            public List<double> Offset { get; set; } = new List<double> { 0, 0 };
